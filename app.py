...
def obtener_tabla_bogota():
    ...
    if not enlace_excel:
        return pd.DataFrame({"Error": ["No se encontró el archivo 'Anexo' en la página del DANE."]})
    ...
    columnas_bogota = [col for col in df_limpio.columns if col.startswith('Bogotá, Corabastos')]
...
st.caption("Datos extraídos automáticamente desde el DANE (archivo 'Anexo')")
...
if st.button("🔄 Actualizar tabla"):
    ...
    st.download_button("📥 Descargar como CSV", data=csv, file_name="precios_bogota.csv", mime='text/csv')
